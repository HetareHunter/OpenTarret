...
namespace Parabox.CSG
{
    ...
    public sealed class CSG_Model
    {
        ...
        public CSG_Model(GameObject gameObject) :
            this(gameObject.GetComponent<MeshFilter>()?.sharedMesh,//meshの情報を渡す
                gameObject.GetComponent<MeshRenderer>()?.sharedMaterials,//materialの情報を渡す
                gameObject.GetComponent<Transform>())//位置、回転、大きさを渡す
        {
        }
        ...
        public CSG_Model(Mesh mesh, Material[] materials, Transform transform)
        {
            ...
            //"mesh"の頂点群の位置、色、法線、接線、UV0、2、3、4をワールド空間に変換し、
        ...
        /// <summary>
        /// CSG_NodeクラスのコンストラクタにList<CSG_Polygon>型を渡すものがある
        /// </summary>
        /// <returns></returns>
